...
Currently available applets include:
	...
	addgroup, adduser, arp, arping, ash, awk, basename, bash, brctl,
	bunzip2, bzcat, bzip2, cat, chgrp, chmod, chown, chpasswd, chroot,
	clear, cp, crond, crontab, cut, date, dd, df, dirname, dmesg,
	dnsdomainname, dos2unix, du, echo, egrep, eject, env, ether-wake,
	expr, false, fdisk, fgrep, find, flock, free, fuser, grep, gunzip,
	gzip, head, hostname, i2ctransfer, ifconfig, inetd, insmod, kill,
	killall, klogd, ln, logger, login, losetup, ls, lsmod, lsof, lsusb,
	md5sum, mdev, microcom, mkdir, mkfs.ext2, mknod, mkswap, modprobe,
	more, mount, mountpoint, mv, netstat, nice, nslookup, ntpd, passwd,
	pgrep, pidof, ping, ping6, printf, ps, pwd, reboot, rm, rmdir,
	rmmod, route, sed, sendmail, seq, sh, sleep, sort,
	start-stop-daemon, stat, strings, swapoff, swapon, switch_root,
	sync, sysctl, syslogd, tail, tar, tee, telnetd, test, time, top,
	touch, tr, traceroute, traceroute6, true, ts, udhcpc, umount, uname,
	uniq, unix2dos, unlink, uptime, usleep, vconfig, vi, watch, wc,
...
bash [-/+OPTIONS] [-/+o OPT]... [-c 'SCRIPT' [ARG0 [ARGS]] / FILE [ARGS] / -s [ARGS]]
...
Read user:password from stdin and update /etc/passwd
	...
	-c,--crypt-method ALG	des,md5,sha256/512 (default m)
...
tar c|x|t [-zjhvokO] [-f TARFILE] [-C DIR] [-T FILE] [-X FILE] [--exclude PATTERN]... [FILE]...
