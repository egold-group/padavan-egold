...
#define DEF_WLAN_2G_SSID	BOARD_PID "_p_%s"
#define DEF_WLAN_5G_SSID	BOARD_PID "_p_5G_%s"
#define DEF_WLAN_2G_GSSID	BOARD_PID "_p_GUEST_%s"
#define DEF_WLAN_5G_GSSID	BOARD_PID "_p_GUEST_5G_%s"
